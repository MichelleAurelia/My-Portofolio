...
import aboutPic from '../../assets/profile1.jpg';
  ...
  return (
    <section className={styles.container} id="about">
      ...
      <div className={styles.content}>
        ...
        <p className={styles.about} data-aos="fade-left">
      ...
      <div className={styles.bgBox} data-aos="fade-right">
        <ul className={styles.navTabs}>
          <a>
            <li
              className={`${styles.tab} ${toggle === 1 ? 'is-active' : ''}`}
          ...
          <a>
            <li
              className={`${styles.tab} ${toggle === 2 ? 'is-active' : ''}`}
          ...
          <a>
            <li
              className={`${styles.tab} ${toggle === 3 ? 'is-active' : ''}`}
        ...
        <div className={styles.tabContent}>
          <div
            className={toggle === 1 ? styles.showContent : styles.tabPanel}
          >
            <h1>Skills</h1>
            <h3>Languages</h3>
            <li>Indonesian</li>
          ...
          <div
            className={toggle === 2 ? styles.showContent : styles.tabPanel}
          >
            <h1>Experiences</h1>
          ...
          <div
            className={toggle === 3 ? styles.showContent : styles.tabPanel}
          >
            <h1>Education</h1>
